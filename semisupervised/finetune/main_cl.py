...
parser.add_argument('--aug2', type=str, default="dropN_cp")
...
model_PATH = "../pre-training/models/" + args.dataset + "_" + args.aug1 + "_" + str(args.aug_ratio1) + "_" + args.aug2 + "_" + str(args.aug_ratio2) + "_" + str(20) + "_" + args.model_lr + "_" + str(args.suffix) + ".pt"
