...
def main():
    ...
    dataset = MoleculeDataset("/home/admin/SGCL/transfer/dataset/" + args.dataset, dataset=args.dataset)

    print(args.dataset)

 
    if args.split == "scaffold":
        smiles_list = pd.read_csv('/home/admin/SGCL/transfer/dataset/' + args.dataset + '/processed/smiles.csv', header=None)[0].tolist()
    ...
    with open('result.log', 'a+') as f:
        f.write(args.dataset + ' ' + str(args.runseed) + ' ' + str(best_test_acc))
        f.write('\n')
